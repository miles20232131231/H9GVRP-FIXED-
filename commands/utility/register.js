...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await interaction.editReply({ content: 'Vehicle has now been registered successfully. If you would like to view it head over to <#1271368739996041257>', ephemeral: true });
        } catch (error) {
